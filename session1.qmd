...
Dernæst indlæser vi og gemmer datasættet `den17-no-nordic-letters.csv`, som ligger mappen `"/data"` i R projketet. Det kan også downloades her: [Download den17](data/den17-no-nordic-letters.csv){.btn .btn-primary}
